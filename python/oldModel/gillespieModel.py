...
class individualGillespieModel:
    ...
    def updateReaction(self):
        ...
        #
        # NOTE
        # This works because we have only death reactions here -> They apply on the individual state
        # Birth reactions have to be implemented as adding an entry to the population state
